   ...
   export function useSettings() {
     ...
     const loadSettings = async () => {
       ...
       try {
         ...
         console.log("[DEBUG useSettings.loadSettings] Calling settingsApi.get()...");
         const data = await settingsApi.get();
         console.log("[DEBUG useSettings.loadSettings] API response:", data);
         
         setSettings(data);
         console.log("[DEBUG useSettings.loadSettings] Settings loaded successfully");
       } catch (err) {
         ...
         console.log("[DEBUG useSettings.loadSettings] Using default settings:", defaultSettings);
     ...
     const updateSettings = useCallback(
       async (updates: UpdateSettingsRequest) => {
         ...
         console.log("[DEBUG useSettings.updateSettings] Current settings:", settings);
         ...
         try {
           ...
           console.log("[DEBUG useSettings.updateSettings] Calling settingsApi.update...");
           const updated = await settingsApi.update(updates);
           console.log("[DEBUG useSettings.updateSettings] API call successful:", updated);
           
           setSettings(updated);
           console.log("[DEBUG useSettings.updateSettings] Settings state updated");
           ...
           console.log("[DEBUG useSettings.updateSettings] Setting isSaving=false");
           setIsSaving(false);
         }
       },
     ...
     const updatePromptCustomization = useCallback(
       async (promptCustomization: string) => {
         console.log("[DEBUG useSettings.updatePromptCustomization] Called with:", promptCustomization);
