...
export function MSWProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    console.log(
      "[MSWProvider] NEXT_PUBLIC_DISABLE_MSW:",
      process.env.NEXT_PUBLIC_DISABLE_MSW,
    );
    console.log(
      "[MSWProvider] NEXT_PUBLIC_API_MOCKING:",
    ...
    const initMSW = async () => {
      ...
      if (mswDisabled || !mswEnabled) {
        console.log(
          "[MSWProvider] ✅ MSW DISABLED - Using real backend at",
